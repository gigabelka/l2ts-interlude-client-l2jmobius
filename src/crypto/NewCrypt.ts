...
/**
 * NewCrypt — Blowfish ECB wrapper with L2 checksum and XOR operations.
 * Used by LoginCrypt for Login Server packet encryption/decryption.
 */
export default class NewCrypt {
  ...
  /** Reverse rolling XOR pass for Init packet decryption. */
